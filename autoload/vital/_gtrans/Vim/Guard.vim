...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gtrans#Vim#Guard#import() abort
  ...
  execute join(['function! vital#_gtrans#Vim#Guard#import() abort', printf("return map({'_vital_depends': '', '_vital_created': '', 'store': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
